...
plt.bar(counts_train[0], counts_train[1], color='blue', label='Train', tick_label=counts_train[0], width=0.2)
plt.bar(counts_test[0]+0.2, counts_test[1], color='red', label='Test', width=0.2)
plt.legend()
plt.show()
