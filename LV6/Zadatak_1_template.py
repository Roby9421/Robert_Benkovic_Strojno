...
print("Accuracy train: " + "{:0.3f}".format((accuracy_score(y_train, y_train_p))))
print("Accuracy test: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p))))
...
print("Kada je k=1 događa se overfit, a kada je k=100, događa se underfit")
KNN_model.fit(X_train_n, y_train)
y_train_p_KNN = KNN_model.predict(X_train_n)
y_test_p_KNN = KNN_model.predict(X_test_n)

print("KNN: ")
print("Accuracy train: " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_KNN))))
print("Accuracy test: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p_KNN))))
...
print("SVM: ")
print("Accuracy train: " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_SVM))))
print("Accuracy test: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p_SVM))))
